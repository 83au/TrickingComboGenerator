...
var takeoffs = {
  ...
  raiz: ['right left redirect', 'front swing', 'semi', 'hook', 'outside leg reversal', 'skip invert', 'vanish'],
...
var tricks = {
  ...
  // },
  {
    ...
    name: 'Auto-Bahn',
    starter: true,
    setups: ['reverse pop', 'hook carry-through', 'outside leg reversal', 'right left redirect', 'cheat', 'hook'],
