...
var takeoffs = {
  ...
  raiz: ['vanish cheat', 'front swing', 'Hook Kick', 'outside leg reversal', 'skip invert', 'vanish'],
  backFullTwist: ['Shosei step', 'Front Sweep', 'Tornado', 'invert backside pop', 'invert backside punch'],
  insideFullTwist: ['Aerial', 'Slant Gainer'],
  cartwheel: ['boneless', 'Hook Kick', 'reverse pop']
};
var landingPositions = {
  eagle: ['invert backside pop', 'backside', 'back swing', 'missleg', 'skip invert', // skip from eagle into mega for a front swing
  'vanish'],
  round: ['backside', 'frontside pop', 'inside leg reversal', 'round carry-through', 'skip round', // skip from round kick into wrap or scoot
  'vanish'],
  hook: ['vanish cheat', 'frontside pop', 'hook carry-through', 'inside leg hyper', 'outside leg reversal', 'skip hook' // skip from hook or round into jstep
  ]
};
...
'wrap', 'cheat', 'skip round', // for wraps and scoot setups
...
var tricks = {
  ...
  // },
  {
    ...
    name: 'Feilong',
    starter: true,
    setups: ['inside pop', 'frontside pop', 'frontside punch', 'inside punch', 'cheat', 'vanish cheat'],
    ...
    starter: true,
    notFinisher: true,
    setups: ['vanish', 'hook carry-through', 'vanish cheat', 'reverse pop', 'frontside pop'],
    // cheat is implied
    landings: landingPositions.round
  }, {
    name: 'Tsunami Kick',
  ...
  // },
  {
    ...
    name: 'Tornado Double',
    starter: true,
    setups: ['vanish', 'hook carry-through', 'vanish cheat'],
    // cheat is implied
    landings: landingPositions.round
  }, {
    name: 'Tornado Side Kick',
    starter: true,
    setups: ['vanish', 'hook carry-through', 'vanish cheat', 'reverse pop'],
    // cheat is implied
    landings: landingPositions.round
  }, {
    name: 'Triple Kick',
    ...
    landings: ['inside', 'inside leg hyper', 'Scoot', 'Scoot Hyper', 'reverse vanish', 'vanish cheat', 'inside pop']
  }, {
    name: 'Wackknife',
    starter: true,
...
function generateCombo() {
  var transition; // Clear container
...
function formatMod(mod, trickName) {
  if (mod) {
    ...
    var isTrans = /(pop|punch|hyper|vanish|reversal|carry-through|skip)$/.test(mod);
