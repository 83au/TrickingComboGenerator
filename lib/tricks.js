...
var takeoffs = {
  ...
  raiz: ['right left redirect', 'front swing', 'semi', 'Hook Kick', 'outside leg reversal', 'skip invert', 'vanish'],
...
var landingPositions = {
  ...
  'vanish'],
  hook: ['reverse vanish', 'right left redirect', 'frontside pop', 'hook carry-through', 'inside leg hyper', 'outside leg reversal', 'skip hook' // skip from hook or round into jstep
  ]
};
...
var transitions = ['hook carry-through', 'round carry-through', 'reverse pop', 'frontside pop', 'inside pop', 'backside pop', 'invert frontside pop', // for flips
...
var tricks = {
  ...
  level1: [// KICKS
  {
    name: '360 Wheel Kick',
    starter: true,
    setups: ['inside pop', 'frontside pop', 'inside punch', 'frontside punch', 'cheat', 'right left redirect'],
  ...
  // },
  {
    ...
    starter: true,
    notFinisher: true,
    setups: ['vanish', 'hook carry-through', 'right left redirect', 'reverse pop', 'frontside pop'],
    // cheat is implied
    landings: landingPositions.round
  }, {
    name: 'Tsunami Kick',
  ...
  // },
  {
    ...
    starter: true,
    notFinisher: true,
    setups: ['frontside', 'outside leg reversal', 'semi', 'hook carry-through'],
...
function formatMod(mod, trickName) {
  if (mod) {
    ...
    var isTrans = /(pop|punch|hyper|vanish|reversal|redirect|carry-through|skip)$/.test(mod);
