...
PWA (new major version)
    ...
    9. NEW FEATURE: Add choice in build mode to set maximum difficulty level for a random trick.
    10. Fix styling bugs: 
    ...
    11. NEW FEATURE: User can choose a trick from the list to start a combo?
    12. NEW FEATURE: User can hover over a trick and see an alternate name for the trick that better describes it.
    13. NEW FEATURE: user able to undo as many tricks in the combo as they want.
    14. NEW FEATURE: Have option to share/copy a combo.
    15: NEW FEATURE: User can prioritize specific tricks to have higher chance of being in a combo
    16: NEW FEATURE: User can tap/click on a trick and be taken to a website with info/video example of the trick.
